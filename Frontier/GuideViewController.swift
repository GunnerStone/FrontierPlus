...
class GuideViewController: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        {
            Description.text = "The horse's mane is the long fur on its head and on its rear, and can be a different color than the rest of the horse. A horse's color is defined as the color of their fur, not including the mane or tail. A horse's color is defined as the color of their fur, not including the mane or tail."
